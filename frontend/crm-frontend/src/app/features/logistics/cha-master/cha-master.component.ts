...
interface ChaCommercial {
  defaultClearanceCharge: number;
  documentationCharge: number;
  handlingCharge: number;
  examinationCharge: number;
  gstRate: number;
}
...
export class ChaMasterComponent implements OnInit {
  ...
  protected readonly locationTypes: Option[] = [
    ...
    {
      label: 'Land Customs Station',
      value: 'land_customs_station'
    },
  ...
  protected readonly serviceOptions: Option[] = [
    {
      ...
      value: 'import_customs_clearance'
    },
...

    {
      ...
      value: 'shipping_bill_filing'
    },

    {
      label: 'Bill of Entry Filing',
      value: 'bill_of_entry_filing'
    },
...

    {
      ...
      value: 'customs_examination'
    },

    {
      label: 'Duty Coordination',
      value: 'duty_coordination'
    },

    {
      label: 'Drawback Processing',
      value: 'drawback_processing'
    },
  ...
  protected readonly selectedCha =
    computed(
      () =>
        this.records()
          .find(
  ...
  protected readonly detailSummary =
    computed(() => {
      const cha =
        this.selectedCha();
  ...
  protected loadChaMasters(): void {
    ...
    this.api
      .get<PageResult<ChaVendor>>(
        '/logistics/cha/masters',
        {
          page: 1,
          limit: 100,
          vendorType: 'cha',
      ...
      .subscribe({
        ...
        error:
          (
            ...
            this.errorMessage.set(
              error?.error?.message ||
              'Unable to load CHA master records.'
            )
      });
  }
  ...
  protected saveCha(): void {
    ...
    const request =
      this.selectedId
        ? this.api.patch<ChaVendor>(
            `/logistics/cha/masters/${this.selectedId}`,
            payload
          )
        : this.api.post<ChaVendor>(
            '/logistics/cha/masters',
            payload
          );
  ...
  protected addCha(): void {
    void this.router.navigate(
      [
        '/logistics/cha/master/new'
      ]
    );
  }
  ...
  protected updateStatus(
    ...
    this.api
      .patch(
        `/logistics/cha/masters/${row._id}/status`,
        {
          status:
            nextStatus
        }
      ...
      .subscribe({
        ...
        error:
          (
            ...
            window.alert(
              error?.error?.message ||
              'Unable to delete CHA.'
            )
      });
  }

  protected addLocation(): void {
    this.form.serviceLocations.push({
      locationName:
        '',
  ...
  protected removeLocation(
    index: number
  ): void {
    if (
      this.form.serviceLocations
        .length >
      1
    ) {
      this.form.serviceLocations.splice(
        index,
        1
      );
    }
  ...
  protected hasService(
    value: string
  ): boolean {
    return this.form.servicesOffered
      .includes(
        value
      );
  }
  ...
  private validate(): string {
    if (
      ...
      return 'CHA / Company Name is required.';
    }
    ...
    if (
      ...
      return 'CHA License Number is required.';
    }
    ...
    if (
      ...
      return 'Internal Remarks are required.';
    }
  ...
  private buildPayload():
    ...
    return {
      ...
      paymentTermsOther:
        this.form.paymentTerms ===
        'other'
          ? this.form.paymentTermsOther
              .trim()
          : '',

      creditDays:
        Number(
          this.form.creditDays ||
          0
        ),

      openingPayable:
        Number(
          this.form.openingPayable ||
          0
        ),
  ...
  private emptyCommercial():
    ChaCommercial {
    return {
      defaultClearanceCharge:
        0,
